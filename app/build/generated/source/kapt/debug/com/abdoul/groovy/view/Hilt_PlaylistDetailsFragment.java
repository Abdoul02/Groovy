...
public abstract class Hilt_PlaylistDetailsFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_PlaylistDetailsFragment() {
    super();
  }

  Hilt_PlaylistDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    ((PlaylistDetailsFragment_GeneratedInjector) generatedComponent()).injectPlaylistDetailsFragment(UnsafeCasts.<PlaylistDetailsFragment>unsafeCast(this));
  }
