...
public abstract class Hilt_PlaylistFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_PlaylistFragment() {
    super();
  }

  Hilt_PlaylistFragment(int contentLayoutId) {
  ...
  protected void inject() {
    ((PlaylistFragment_GeneratedInjector) generatedComponent()).injectPlaylistFragment(UnsafeCasts.<PlaylistFragment>unsafeCast(this));
  }
